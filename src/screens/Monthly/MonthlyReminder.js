  ...
  const logRepeatReminderData = () => {
    db.transaction(tx => {
      tx.executeSql(
        ...
        error => {
          console.error(
            'Error fetching data from repeatreminder table:',
            error,
          );
        },
      );
  ...
  const setReminderTwo = () => {
    if (
      ...
      const intervalInMillis =
        (parseInt(hour) * 60 + parseInt(minute)) * 60 * 1000;
      ...
      const filteredIntervals = filterIntervalsByDuration(
        filteredData,
        selectedDuration,
      );
      db.transaction(tx => {
      ...
      db.transaction(tx => {
        tx.executeSql(
          ...
          [
            ...
            title,
            notes,
            'Monthly', // Set the constant value for the "category" column
          ],
          (tx, result) => {
            console.log('Reminder inserted successfully');
          },
  ...
  return (
    <View style={MonthlyReminderStyle.container}>
      <View style={MonthlyReminderStyle.headerContainer}>
        ...
        <Text style={MonthlyReminderStyle.title}>MONTHLY</Text>
        <TouchableHighlight onPress={navigateToMainScreen}>
          <Text>Cancel</Text>
        </TouchableHighlight>
      </View>
      <Text style={MonthlyReminderStyle.text}>
        Repeat at an interval of {selectedDuration || '_'} weeks
      </Text>
      <Text style={MonthlyReminderStyle.text}>
        Between: {chosenStartDate || '_'} to {chosenEndDate || '_'}
      </Text>
      <Text style={MonthlyReminderStyle.text}>
        Between {chosenStartTime || '_'} to {chosenEndTime || '_'} every{' '}
        {hour || '_'} hour {minute || '_'} mins
      </Text>
      ...
      <View style={MonthlyReminderStyle.rowContainer}>
        ...
        <View style={MonthlyReminderStyle.pickerContainer}>
          <View>
            <TouchableHighlight
              style={MonthlyReminderStyle.customButton}
              onPress={showStartDatePicker}>
              <Text style={MonthlyReminderStyle.customButtonText}>
                Start Date{' '}
              </Text>
            </TouchableHighlight>
          </View>
        ...
        <View style={MonthlyReminderStyle.optionContainer}>
          ...
          <TouchableOpacity
            style={[
              ...
              selectedOption === 'week'
                ? MonthlyReminderStyle.selectedOption
                : null,
            ]}
            onPress={() => handleOptionPress('week')}></TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            onPress={() => handleOptionPress('day')}></TouchableOpacity>
        </View>
      </View>
      <View style={MonthlyReminderStyle.rowContainer}>
        {selectedOption === 'week' ? (
          <View>
            <View style={MonthlyReminderStyle.rowContainer}>
              ...
              <ModalDropdown
                ...
                onSelect={(index, value) =>
                  handleDurationSelect(index, duration[index].value)
                }
            ...
            <View style={{...MonthlyReminderStyle.rowContainer}}>
              ...
              <View
                style={{
                  ...MonthlyReminderStyle.monthChooser,
                  marginLeft: '10%',
                }}>
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      selectedWeeks.includes(week)
                        ? MonthlyReminderStyle.selectedMonthOption
                        : null,
                    ]}
          ...
          <View>
            <View style={MonthlyReminderStyle.rowContainer}>
              ...
              <TouchableHighlight
                style={{
                  ...MonthlyReminderStyle.customButton,
                  marginLeft: '32%',
                }}
                onPress={openModal}>
                <Text style={{...MonthlyReminderStyle.customButtonText}}>
                      ...
                      {Array.from({length: 31}, (_, index) => index + 1).map(
                        date => (
                          <Button
                            ...
                            style={{
                              margin: 5,
                              backgroundColor: selectedDates[date]
                                ? 'blue'
                                : 'white',
      ...
      <TouchableOpacity
        style={MonthlyReminderStyle.customButtonDone}
        onPress={() => {
        ...
        <Text
          style={{
            ...MonthlyReminderStyle.customButtonText,
            fontWeight: 'bold',
          }}>
          Done
        </Text>
